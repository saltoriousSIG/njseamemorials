    ...
    <div className="space-y-6 text-black text-left mt-0 mb-10">
      <section className="rounded-lg p-6">
        ...
        <p className="mb-2">
          ...
          booking. In the event a double booking occurs, the trip will go to the
          charter who booked first. You will be called ASAP if a double booking
          happens to occur to reschedule.
        </p>
        <p className="mb-2">
        ...
        <p className="mb-2">
          Deposits Are NON-Refundable. If a reschedule is needed within 30 days
          of the booked trip, we will gladly change the date for you. If the
          trip is canceled due to weather or unforeseen circumstances, the
        ...
        <p className="mb-2">
          ...
          year following the original booking. After one year, the deposit will
          be forfeited.
        </p>
        <p className="mb-2">
        ...
        <p className="">
          On the rare occasion paying in cash is not an option, Venmo or PayPal
          may be used. A 3.5% surcharge will be added for all electronic money
          transfers.
        </p>
      </section>
      ...
      <section className="rounded-lg p-6">
        ...
        <ul className="list-disc pl-5">
          ...
          <li className="list-none">
            You are welcome to have your ceremony catered. **The catering needs
            to be punctual due to the likelihood of other trips being booked
            before and/or after your ceremony.
          </li>
          <li className="list-none">
          ...
          <li className="list-none">
            For food, we advise pre-packaged meals and sandwiches.
          </li>
          <li className="list-none">Wine and hard liquor are not permitted.</li>
          <li className="list-none">
            Always dress appropriately for the seasonal conditions; evenings are
            cooler than you expect. We advise you dress in layers.
          </li>
          <li className="list-none">
