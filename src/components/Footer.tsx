...
const Footer: React.FC<FooterProps> = () => {
  return (
    <footer className="flex w-full gap-2 sm:flex-row py-6 pr-20 shrink-0 items-start justify-between border-t bg-slate-800 h-[292px] relative">
      <div className="h-full flex flex-col justify-between w-[276px]">
        <img src="/logo_white.png" />
        <p className="whitespace-nowrap p-5 text-sm">&copy; {new Date().getFullYear()} NJ Sea Memorials. All rights reserved.</p>
      </div>
      <div className="flex items-start justify-start gap-x-14 top-1/2 relative -translate-y-1/2 ">
        <div className="flex flex-col items-start justify-start text-left space-y-3">
          <a href="/" className="text-white">
            Home
          </a>
          <a href="/theexperience" className="text-white">
            The Experience
          </a>
          <a href="/whyseaburial" className="text-white">
            Why A Sea Burial
          </a>
        ...
        <div className="flex flex-col items-start justify-start text-left space-y-3">
          <a href="/prices" className="text-white">
            Prices
          </a>
      ...
      <div className="flex flex-col space-y-5">
        <div className="flex space-x-4">
          <a href="https://www.facebook.com/NJSeaMemorials" target="_blank">
